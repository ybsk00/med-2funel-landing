...
interface DepartmentAppointmentListPageProps {
    dept: string;
    config: HospitalConfig;
    initialAppointments: Appointment[];
}

export default function DepartmentAppointmentListPage({
    dept,
    config,
    initialAppointments
}: DepartmentAppointmentListPageProps) {
        ...
        <div className="min-h-screen pb-24" style={{ backgroundColor: '#0a0f1a' }}>
            <div className="max-w-lg mx-auto px-4 pt-6">
                ...
                >
                    ...
                    <Link href={`${basePath}/history`} className="flex-1 py-2.5 px-4 text-sm font-medium text-gray-400 hover:text-gray-300 transition-colors text-center">
                        이전 내역
                    </Link>
                </div>
                    ...
                    <div className="flex items-start gap-3">
                        ...
                        <div className="flex-1">
                            ...
                            <p className="text-sm text-gray-300 leading-relaxed mb-2">
                                {config.name}에서 건강을 관리해보세요. <span className="text-blue-400 font-medium">추천 검진일</span>이 다가오고 있습니다.
                            </p>
                            <Link href={`${basePath}/appointments/new`} className="inline-flex items-center gap-1 text-sm text-blue-400 font-medium hover:text-blue-300 transition-colors">
                ...
                <div className="mb-6">
                    ...
                    {upcomingAppointments.length > 0 ? (
                        ...
                        >
                            ...
                            <Link href={`${basePath}/appointments/new`} className="inline-flex items-center gap-1 text-blue-400 font-medium hover:text-blue-300 transition-colors">
