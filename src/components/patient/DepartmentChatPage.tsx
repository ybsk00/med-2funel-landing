...
export default function DepartmentChatPage({ dept, config }: DepartmentChatPageProps) {
    ...
    const initialGreeting = `안녕하세요, ${config.name} AI 예진 상담입니다. 👨‍⚕️\n\n${config.dept} 관련 고민이 무엇인가요? 불편한 부분을 말씀해주시면 예진 정리를 도와드리겠습니다. (진단/치료 아님)`;
            ...
            <header className="sticky top-0 z-10 px-4 py-3" style={{ backgroundColor: '#0a0f1a', borderBottom: '1px solid #1f2937' }}>
                <div className="flex items-center justify-between max-w-lg mx-auto">
                    ...
                    <div className="text-center">
                        <h1 className="text-lg font-bold text-white">{config.name} AI 예진</h1>
                    ...
                    >
                        ...
                        >
                            ...
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    <h3 className="text-lg font-bold text-white">{config.name} 예약</h3>
                        ...
                        <div className="p-5">
                            ...
                            <div className="mb-4 p-3 rounded-xl flex items-start gap-2" style={{ backgroundColor: '#dbeafe' }}>
                                ...
                                <p className="text-xs text-blue-800">
                                    AI 예진은 참고용입니다. 정확한 진단을 위해 반드시 전문 의료진의 진료를 받으세요.
                                </p>
                            </div>

                            <p className="text-sm text-gray-300 mb-5 leading-relaxed">
                                전문 의료진의 상담을 받아보시겠어요? 지금 바로 예약하시면 빠른 시일 내에 진료받으실 수 있습니다.
                            </p>
