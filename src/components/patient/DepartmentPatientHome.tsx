...
import { Bell, Mic, Calendar, FileText, Pill, MessageSquare, Building2 } from 'lucide-react';
...
interface DepartmentPatientHomeProps {
    dept: string;
...
export default function DepartmentPatientHome({
    dept,
    config,
    patientName,
    upcomingAppointment
        ...
        <TrackReturningCustomerView>
            <div className="min-h-screen pb-24" style={{ backgroundColor: '#0a0f1a' }}>
                <div className="max-w-lg mx-auto px-4 pt-6">
                    ...
                    {/* Condition Check */}
                    <div className="mb-8">
                        <p className="text-gray-400 text-sm mb-1">{config.dept} 고민이</p>
                        ...
                        <Link href={`${basePath}/chat`}>
                            ...
                            >
                                ...
                                <h3 className="text-xl font-bold text-white mb-2">증상 정리</h3>
                    ...
                    <div className="grid grid-cols-5 gap-3 mb-8">
                        <Link href={`${basePath}/appointments/new`} className="flex flex-col items-center gap-2">
                            <div
                        ...
                        <Link href={`${basePath}/history`} className="flex flex-col items-center gap-2">
                            <div
                                className="w-12 h-12 rounded-2xl flex items-center justify-center"
                                style={{ backgroundColor: '#1f2937' }}
                            >
                        ...
                        <Link href={`${basePath}/medications`} className="flex flex-col items-center gap-2">
                            <div
                                className="w-12 h-12 rounded-2xl flex items-center justify-center"
                                style={{ backgroundColor: '#1f2937' }}
                            >
                        ...
                        <Link href={`${basePath}/hospitals`} className="flex flex-col items-center gap-2">
                            <div
                                className="w-12 h-12 rounded-2xl flex items-center justify-center"
                                style={{ backgroundColor: '#1f2937' }}
                            >
                        ...
                        <Link href={`${basePath}/chat`} className="flex flex-col items-center gap-2">
                            <div
                                className="w-12 h-12 rounded-2xl flex items-center justify-center"
                                style={{ backgroundColor: '#1f2937' }}
                            >
                    ...
                    {/* 가상 시각화 CTA - Only if enabled for department */}
                    {showSimulation && (
                        <div className="mb-8">
                            <FaceSimulationCTA />
                        </div>
                            ...
                            >
                                ...
                                <div className="flex-1">
                                    ...
                                    <p className="text-sm text-gray-400">
                                        {upcomingAppointment.notes || config.name}
                                    </p>
                                </div>
                            </div>
                        ) : (
                    ...
                    >
                        ...
                        <div className="flex-1">
                            <h4 className="text-sm font-bold text-white">{config.dept} 관리 안내</h4>
                            <p className="text-xs text-gray-400">정기적인 관리로 건강을 유지하세요.</p>
                        </div>
