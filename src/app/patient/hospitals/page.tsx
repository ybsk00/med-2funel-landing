...
export default function HospitalSearchPage() {
    ...
    return (
        <div className="min-h-screen bg-dental-bg text-dental-text">
            {/* 헤더 */}
            <header className="bg-dental-bg/80 backdrop-blur-md border-b border-white/10 px-4 py-3 sticky top-0 z-10">
                <div className="flex items-center gap-3">
                    <Link href="/patient" className="p-2 -ml-2 text-dental-subtext hover:text-white transition-colors">
                        <ArrowLeft size={24} />
                    </Link>
                    <div>
                        <h1 className="text-lg font-bold text-white">병원 조회</h1>
                        <p className="text-xs text-dental-subtext">휴일/야간 병원 · 응급실 혼잡도</p>
                    </div>
                </div>
            </header>
