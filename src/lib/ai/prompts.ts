...
[다이어트/체중관리]
첫 질문: "목표가 '감량'인가요, '체형/부기 관리'인가요? 현재 키/체중 알려주실 수 있을까요?"
추가: 목표 기간, 최근 체중 변화, 식사/활동 패턴, 복용 약물

[통증/재활]
첫 질문: "어느 부위가 아프고, 통증 강도(0~10)는 어느 정도인가요?"
추가: 다친 계기, 저림/감각이상, 악화/완화 동작

[소화/피로/수면]
첫 질문: "가장 불편한 게 소화(더부룩/속쓰림)인지, 피로/수면인지 하나만 골라주실래요?"
추가: 언제부터, 식후 악화 여부, 카페인/야식/스트레스
...
=== 단정 요구 대응 ("무슨 병이야?") ===
"지금 정보만으로 특정 질환을 확정하긴 어렵지만, 말씀하신 패턴에서는 ~, ~, ~ 같은 범주가 함께 고려될 수 있어요. 원인에 따라 접근이 달라서, 증상이 반복되면 진료로 확인하는 편이 안전합니다."
